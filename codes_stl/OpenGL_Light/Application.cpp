...
int main()
{
	...
	//position of light object in 3d space
	glm::vec3 light_Pos = glm::vec3(2.0f, 0.0f, -2.0f);


	while (!glfwWindowShouldClose(window))
	{
		//glClearColor(0.2f, 0.3f, 0.8f, 1.0f);
		glClearColor(0.25f, 0.75f, 0.85f, 1.0);
...
#ifdef WASD_INPUT
		{
			...
			myshader.SetUniform4f("objectColor", 1.0f, 0.5f, 0.31f, 1.0f);
			myshader.SetUniform4f("lightColor", 1.0f, 1.0f, 1.0f, 1.0f);


			//view matrix
			view = fly_camera.GetViewMatrix();
